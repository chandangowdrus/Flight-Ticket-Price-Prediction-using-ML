...
def main():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://images.pexels.com/photos/348481/pexels-photo-348481.jpeg?auto=compress&cs=tinysrgb&w=600");
    ...
    with st.container():
        st.markdown(
            """
            <h1 style='text-align: center; color: #000000;'>Flight Price Prediction</h1>
            """,
            unsafe_allow_html=True
        )
        ...
        if st.button('Predict Price'):
            ...
            st.markdown(
                """
                <h3 style='text-align: center; color: #ff5733;'>You will have to pay approximately Rs. {}</h3>
